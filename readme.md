This project uses fedora livecd-creator which you may find more info about from link below and elsewhere.
...
also, more awesome livecd image work from another person listed below. I have reused some of their work as in this project as well. Here's an example:
...
*Last note: If you follow me around trying to nixay everything I do as bad and punish those that so called "enable me", 
YOUR GOING TO BE VERY BUSY, SO SADDLE UP COWBOY! Take that to the ...

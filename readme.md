...
*Furthermore: If you intend follow me(troll) around trying to nixay everything I do as bad(dismiss) and punish(disiminate) those that so called "enable me", YOUR GOING TO BE VERY BUSY, SO SADDLE UP COWBOY! Take that to the ... and tell Confefe I said hi!

...
*Side notes for trolls and/or trollbots: D
	...
	Furthermore: If you intend to follow me(trolling) around trying to nixay everything I do as bad(dismissing) and punish(disiminattion) those that so called "enable me". Well, YOUR GOING TO BE VERY BUSY, SO SADDLE UP COWBOY! Take that to the ... and tell ole Confefe I said hi!
